...
{
    /// <summary>
    /// Bir toast nesne örneği içerir 
    /// Kullanıcı etkileşimlerini yönetir ve durum geçişlerini düzenler
    /// </summary>
    public class VedasToast : IDisposable
    {
        ...
        public event Action<VedasToast> OnClose;
        public event Action OnUpdate;
        public ToastType Type => State.Options.Type;

        internal VedasToast(string title, string message, ToastOptions options)
        {
            Title = title;
            Message = message;

#pragma checksum "C:\Users\t1emrullahisik\source\repos\Vedas_Portal\VedasPortal\Pages\IzinTalep\Admin\GelenIzinTalepleri.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5096eecb50095707cc1a0ec9b963ed8e42cb6f99"
// <auto-generated/>
#pragma warning disable 1591
namespace VedasPortal.Pages.IzinTalep.Admin
{
    #line hidden
    using System;
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Components.RouteAttribute("/GelenIzinTalepleri")]
    public partial class GelenIzinTalepleri : global::Microsoft.AspNetCore.Components.ComponentBase
    {
        #pragma warning disable 1998
        protected override void BuildRenderTree(global::Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder __builder)
        {
            __builder.AddMarkupContent(0, "<div class=\"row\"><div class=\"col-12\"><div class=\"card\"><div class=\"card-header\"><h4> Tüm İzin Talepleri </h4></div>\r\n\t\t\t<div class=\"card-body\"><div class=\"table-responsive\"><table class=\"table table-striped\" id=\"table-2\"><thead><tr><th class=\"text-center pt-3\"><div class=\"custom-checkbox custom-checkbox-table custom-control\"><input type=\"checkbox\" data-checkboxes=\"mygroup\" data-checkbox-role=\"dad\" class=\"custom-control-input\" id=\"checkbox-all\">\r\n\t\t\t\t\t\t\t\t\t\t<label for=\"checkbox-all\" class=\"custom-control-label\">&nbsp;</label></div></th>\r\n\t\t\t\t\t\t\t\t<th>Resim</th>\r\n\t\t\t\t\t\t\t\t<th>Personel Adı</th>\r\n\t\t\t\t\t\t\t\t<th>İzin Gün Sayısı</th>\r\n\t\t\t\t\t\t\t\t<th>Başlama Tarihi </th>\r\n\t\t\t\t\t\t\t\t<th>Bitiş Tarihi</th>\r\n\t\t\t\t\t\t\t\t<th>İşlemler</th></tr></thead>\r\n\t\t\t\t\t\t<tbody><tr><td class=\"text-center pt-2\"><div class=\"custom-checkbox custom-control\"><input type=\"checkbox\" data-checkboxes=\"mygroup\" class=\"custom-control-input\" id=\"checkbox-1\">\r\n\t\t\t\t\t\t\t\t\t\t<label for=\"checkbox-1\" class=\"custom-control-label\">&nbsp;</label></div></td>\r\n\t\t\t\t\t\t\t\t<td>Resim</td>\r\n\t\t\t\t\t\t\t\t<td>Personel Adı</td>\r\n\t\t\t\t\t\t\t\t<td>İzin Gün Sayısı</td>\r\n\t\t\t\t\t\t\t\t<td>Başlama Tarihi </td>\r\n\t\t\t\t\t\t\t\t<td>Bitiş Tarihi</td>\r\n\t\t\t\t\t\t\t\t<td><a href=\'/izin/duzenle\' class=\"btn btn-info btn-outline-dark\" role=\"button\">Düzenle</a> |\r\n\t\t\t\t\t\t\t\t\t<a href=\"etkinlikkategoridetay\" class=\"btn btn-primary\">\r\n\t\t\t\t\t\t\t\t\t\tİzin Detayı\r\n\t\t\t\t\t\t\t\t\t</a>|\r\n\t\t\t\t\t\t\t\t\t<button class=\"btn btn-danger\" data-toggle=\"modal\" data-target=\"#deleteEmpModal\" )\">\r\n\t\t\t\t\t\t\t\t\t\tSil\r\n\t\t\t\t\t\t\t\t\t</button></td></tr></tbody></table></div></div></div></div></div>");
        }

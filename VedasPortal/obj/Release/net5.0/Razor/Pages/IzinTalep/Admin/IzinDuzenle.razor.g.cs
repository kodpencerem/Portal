#pragma checksum "C:\Users\t1emrullahisik\source\repos\Vedas_Portal\VedasPortal\Pages\IzinTalep\Admin\IzinDuzenle.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d6afde3349c1cb57f28d029595d1b9405e8dbff7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Components.RouteAttribute("/izin/ekle")]
    [global::Microsoft.AspNetCore.Components.RouteAttribute("/izin/duzenle/")]
    public partial class IzinDuzenle : global::Microsoft.AspNetCore.Components.ComponentBase
    {
        #pragma warning disable 1998
        protected override void BuildRenderTree(global::Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder __builder)
        {
            __builder.AddMarkupContent(0, "<h4 style=\"margin:10px\">İzni Duzenle</h4>\r\n<hr>\r\n\r\n");
            __builder.AddMarkupContent(1, @"<section style=""margin-left:5px"" class=""container""><div class=""form-group row""><label class=""control-label col-md-12"">Resim</label>
		<div class=""col-md-4""><text class=""form-control""></text></div></div>

	<div class=""form-group row""><label class=""control-label col-md-12"">Personel  Adı</label>
		<div class=""col-md-4""><text class=""form-control""></text></div></div>

	<div class=""form-group row""><label class=""control-label col-md-12"">İzin Açıklama</label>
		<div class=""col-md-4""><text class=""form-control""></text></div></div>

	<div class=""form-group row""><label class=""control-label col-md-12"">Başlangıç Tarihi</label>
		<div class=""col-md-4""><text class=""form-control""></text></div></div>

	<div class=""form-group row""><label class=""control-label col-md-12"">Bitiş Tarihi</label>
		<div class=""col-md-4""><text class=""form-control""></text></div></div>

	<div class=""form-group""><button type=""submit"" class=""btn btn-primary"">Kaydet</button>
		<button class=""btn btn-light"">Vazgeç</button></div></section>");
        }
